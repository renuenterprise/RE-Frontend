    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="mx-auto h-20 w-20 p-3 rounded-full flex items-center justify-center mb-4 shadow-lg">
            <Image
              src={Logo}
              width={1920}
              height={1920}
          ...
          <h2 className="LogoTxt text-3xl font-bold text-gray-900 mb-2">Renu Enterpriser</h2>
